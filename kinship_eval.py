...
parser.add_argument("--config",type = str,default='E:\AWK-main\AWK-main\configs\configs.yml')
parser.add_argument("-t","--type",type = str, default='TSKINFACE',help='TSKINFACE or KINFACE1 or KINFACE2')
parser.add_argument("--conv",type = str, default='conv1234',help='conv14 or conv1234')
parser.add_argument("--pretrained",type = bool, default=True)
parser.add_argument("--feature_encoder",type = str, default="E:\AWK-main\AWK-main\KINFACE2_model/feature_encoder_TSKINFACE_TSKINFACE_conv1234_awk_K_PAIR_2_SPLIT_5_a_0.6_m_0.4.pkl")
parser.add_argument("--relation_network",type = str, default="E:\AWK-main\AWK-main\KINFACE2_model/relation_network_TSKINFACE_TSKINFACE_conv1234_awk_K_PAIR_2_SPLIT_5_a_0.6_m_0.4.pkl")
