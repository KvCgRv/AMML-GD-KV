...
def main():
    ...
    if args.pretrained:
        feature_encoder_parents.load_state_dict(
            torch.load('KINFACE2_model/feature_encoder_parentsKINFACE2_KINFACE2_conv1234_MV_K_PAIR_1_SPLIT_3.pth'))
        feature_encoder_children.load_state_dict(
            torch.load('KINFACE2_model/feature_encoder_childrenKINFACE2_KINFACE2_conv1234_MV_K_PAIR_1_SPLIT_3.pth'))
        relation_network.load_state_dict(
            torch.load('KINFACE2_model/relation_network_KINFACE2_KINFACE2_conv1234_MV_K_PAIR_1_SPLIT_3.pth'))
        if args.loss == 'MV':
            MV.load_state_dict(
                torch.load('KINFACE2_model/MVLossKINFACE2_KINFACE2_conv1234_MV_K_PAIR_1_SPLIT_3.pth'))
