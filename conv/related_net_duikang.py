...
class CNNEncoder_1234(nn.Module):
    ...
    def forward(self,x):
        out1 = self.layer1(x)
        #print("shape of out1 is", out1.shape)
        out1 = self.layer5(out1) + out1
        out2 = self.layer2(out1)
        #print("shape of out2 is", out2.shape)
        out2 = self.layer5(out2) + out2

        out3 = self.layer3(out2)
       #print("shape of out3 is", out3.shape)
        #out3 = self.layer5(out3) + out3
        out4 = self.layer4(out3)
        #print("shape of out4 is", out4.shape)
...
class RelationNetwork_1234(nn.Module):
    ...
    def __init__(self,input_size,hidden_size):
        ...
        self.fc1 = nn.Linear(6*6*input_size,hidden_size)
        self.fc2_test = nn.Linear(hidden_size,8)
...
class Domain_RelationNetwork_1234_0(nn.Module):
    ...
    def __init__(self,input_size,hidden_size):
        ...
        self.batch_norm_layer = torch.nn.BatchNorm2d(num_features=1)
        self.fc1 = nn.Linear(6*6*input_size,hidden_size)
        self.fc2_test = nn.Linear(hidden_size,4)
